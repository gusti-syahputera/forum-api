...
describe('GetAuthenticationUseCase', () => {
  it('should orchestrating the get authentication action correctly', async () => {
    ...
    const mockUserRepository: UserRepository = {
      ...
      verifyAvailableUsername: jest.fn().mockImplementation(() => {})
    }
    const mockAuthenticationRepository: AuthenticationRepository = {
      ...
      checkAvailabilityToken: jest.fn().mockImplementation(() => {}),
    ...
    const mockAuthenticationTokenManager: AuthenticationTokenManager = {
      ...
      decodePayload: jest.fn().mockImplementation(() => {}),
      verifyRefreshToken: jest.fn().mockImplementation(() => {})
    }
    const mockPasswordHash: PasswordHash = {
      comparePassword: jest.fn().mockImplementation(async () => await Promise.resolve()),
      hash: jest.fn().mockImplementation(async () => await Promise.resolve())
    }
